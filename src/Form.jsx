    ...
    render() {
        ...
        return (
            <>
                ...
                <input type='radio' name='gender' value='male' onChange={(e) => this.setState({ gender: e.target.value })} /> Male  <nbsp></nbsp>
                ...
                <input type='checkbox' value='Reading' onChange={this.handleHobbyChange} /> Reading <nbsp></nbsp>
                <input type='checkbox' value='Traveling' onChange={this.handleHobbyChange} /> Traveling <nbsp></nbsp>
                <input type='checkbox' value='Gaming' onChange={this.handleHobbyChange} /> Gaming <nbsp></nbsp>
                <input type='checkbox' value='Music' onChange={this.handleHobbyChange} /> Music <nbsp></nbsp>
